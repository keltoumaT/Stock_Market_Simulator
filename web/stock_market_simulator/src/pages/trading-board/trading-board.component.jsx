...
class TradingBoard extends React.Component {
  ...
  handleBuy = (event) => {
    ...
    axios
      .post(
        "http://localhost:8585/api/private/deals",
        {
    ...
    if (this.state.currentSymbol !== "") {
      return (
        <div id="trading_board_body">
          ...
          <br />
          <CompanyTable
            getCompanyObj={this.getCompanyObj.bind(this)}
            key={this.state.currentSymbol}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  />
                  <button id="buy_button" onClick={this.handleBuy}>
                    BUY
                  </button>
                </td>
              </tr>
